...
ALTER TABLE `ims_ewei_shop_goods` ADD COLUMN `buyagain_price` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `ims_ewei_shop_goods` ADD COLUMN `threen` varchar(255) DEFAULT '';
ALTER TABLE `ims_ewei_shop_order` ADD COLUMN `contype` tinyint(1) DEFAULT '0';
ALTER TABLE `ims_ewei_shop_order` ADD COLUMN `wxid` int(11) DEFAULT '0';
ALTER TABLE `ims_ewei_shop_order` ADD COLUMN `wxcardid` varchar(50) DEFAULT '';
ALTER TABLE `ims_ewei_shop_order` ADD COLUMN `wxcode` varchar(50) DEFAULT '';
ALTER TABLE `ims_ewei_shop_order` ADD COLUMN `dispatchkey` varchar(30) NOT NULL DEFAULT '';
ALTER TABLE `ims_ewei_shop_task_poster` ADD COLUMN `autoposter` tinyint(1) NOT NULL DEFAULT '0';
