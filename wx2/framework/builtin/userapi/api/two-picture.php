...
if ($resp['code'] == 200 && $resp['content']) {
	...
	$news[] = array('title' => '今日头条22', 'description' => '头条新闻', 'url' => 'http://toutiao.com/', 'picurl' => 'http://a.hiphotos.baidu.com/baike/w%3D268/sign=db923e4310ce36d3a204843602f23a24/7dd98d1001e93901a1184fa77eec54e736d19615.jpg');
	...
	$response = $this->respImage('1RglewWObHceAUC0Cg63sYMLgpE7_adXsVKFxBdyMfo');
	return $response;
	return $response;
}
