...
<form action="" method="post" onsubmit="return formcheck(this)">
	...
	<table class="table table-responsive">
		...
		<tbody>  
			...
			<tr>
				<td><span data-toggle='tooltip' title='<?php  echo $row['nickname'];?>'><img src='<?php  echo $row['avatar'];?>' style='width:20px;height:20px;padding1px;border:1px solid #ccc' /> <?php  echo $row['nickname'];?></span>
