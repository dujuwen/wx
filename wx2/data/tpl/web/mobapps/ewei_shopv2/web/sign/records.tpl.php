        ...
        <?php  } else { ?>
            <?php  if(is_array($list)) { foreach($list as $item) { ?>
                <tr class="trbody">
                    ...
                    <td>
                        <a href="<?php  echo webUrl('member/list/detail', array('id'=>$item['mid']))?>" target="_blank" title="<?php  echo $item['nickname'];?>"><img src="<?php  echo $item['avatar'];?>" style="width:30px; height:30px; padding: 1px; border:1px solid #ccc;"> <?php  echo $item['nickname'];?></a>
                    </td>
                    <td>
