...
<table class="table table-hover table-responsive"> 
    ...
    <tbody>
        ...
        <tr>
			...
			<td>
				<?php if(cv('goods.edit')) { ?>
                <a href='javascript:;' data-toggle='ajaxEdit' data-edit='textarea'  data-href="<?php  echo webUrl('goods/change',array('type'=>'shorttitle','id'=>$item['id']))?>" ><?php  echo $item['shorttitle'];?></a>
                <?php  } else { ?>
