    ...
    <form action="" method="post">
            <table class="table table-hover table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan='10' style='text-align: left;border-top:none;padding:5px 0;' class='aops'>
                            <span class="text-default" style="margin-left: 95px;">商户名称:</span><span class="text-info"><?php  echo $row['merchname'];?></span>
                        </td>
                    <?php  } ?>
           <?php  } } ?>
        </tbody>
