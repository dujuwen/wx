<?php defined('IN_IA') or exit('Access Denied');?><div class="form-group userinfo" style="margin-bottom: 0;" data-change="0">

	<div class="input-group" style="margin-bottom: 5px;">
		<span class="input-group-addon">收件人姓名</span>
		<input type="text" name="realname" value="<?php  echo $address['realname'];?>" class="form-control valid">
		<span style="border-left: 0;" class="input-group-addon">昵称(<?php  echo $address['nickname'];?>)</span>
		<input type="hidden" name="nickname" value="<?php  echo $address['nickname'];?>" />
		<span style="border-left: 0; border-right: 0;" class="input-group-addon">收件人电话</span>
		<input type="tel" name="mobile" value="<?php  echo $address['mobile'];?>" class="form-control valid">
	</div>

	<div class="input-group">
		<span class="input-group-addon">收件地址</span>
		<input type="text" name="province" value="<?php  echo $address['province'];?>" class="form-control valid">
		<span style="border-left: 0; border-right: 0;" class="input-group-addon">省</span>
		<input type="text" name="city" value="<?php  echo $address['city'];?>" class="form-control valid">
		<span style="border-left: 0; border-right: 0;" class="input-group-addon">市</span>
		<input type="text" name="area" value="<?php  echo $address['area'];?>" class="form-control valid">
		<span style="border-left: 0; border-right: 0;" class="input-group-addon">区</span>
		<input type="text" name="address" value="<?php  echo $address['address'];?>" class="form-control valid" style="width: 314px;">
	</div>
...
<table class="table table-responsive" style="table-layout: fixed;  margin-bottom: 0px;">
		...
		<table class="table table-responsive" style="table-layout: fixed; border-bottom: 1px solid #f2f2f2;  margin-bottom: 0px;">
			...
			<tr class="trorder">
				...
				<td colspan="4">订单编号: <?php  echo $item['ordersn'];?> <?php  if(!empty($item['refundstate'])) { ?><label class='label label-danger'>退款申请</label><?php  } ?></td>
			...
			<?php  if(is_array($item['goods'])) { foreach($item['goods'] as $k => $g) { ?>
				...
				<tr class="trbody print-data" 
					...
					data-print-unit="<?php  echo $g['unit'];?>" data-print-weight="<?php  echo $g['weight'];?>"
					>
					<td style="width: 26px; padding-left: 6px;">
					...
					<?php  if($k==0) { ?>
						<td style="text-align:center;" rowspan="<?php  echo count($item['goods'])?>">
							<label class='label label-<?php  echo $item['css'];?>'><?php  echo $item['paytypename'];?></label>
							<br>
			...
			<?php  } } ?>
				<tr>
					<td style="color: #F27474; text-align: left;" colspan="5">买家备注: <span class="remark1"><?php  if(!empty($item['remark'])) { ?><?php  echo $item['remark'];?><?php  } else { ?>无<?php  } ?></span></td>
					<td style="color: #F0C49B; text-align: right;" colspan="4">卖家备注: <span class="remark2"><?php  if(!empty($item['remarksaler'])) { ?><?php  echo $item['remarksaler'];?><?php  } else { ?>无<?php  } ?></span></td>
				</tr>
</table>
		<?php  } } ?>
...
<table class="table table-responsive" style="table-layout: fixed; margin-bottom: 5px;">
		...
		<tr>
			<td colspan="9" style="height:auto; padding: 0; border: 0;">
				<textarea class="form-control richtext valid sendinfo" style="max-width: 100%; min-width: 100%;"><?php  echo $address['sendinfo'];?></textarea>
			</td>
		</tr>

</table>
		<div class="print-btn">
			<?php if(cv('exhelper.print.single.express')) { ?>
			<a href="javascript:;" class="btn btn-success btn-sm" id="print-express" data-ban = "0" data-cate="1">打印快递单</a>
			<?php  } ?>
			<?php if(cv('exhelper.print.single.invoice')) { ?>
			<a href="javascript:;" class="btn btn-warning btn-sm" id="print-invoice" data-ban = "0" data-cate="2">打印发货单</a>
			<?php  } ?>
			<?php if(cv('exhelper.print.single.dosend')) { ?>
			<a href="javascript:;" class="btn btn-primary btn-sm" id="print-send" data-ban = "0">一键发货</a>
			<?php  } ?>
			<?php if(cv('exhelper.print.single.express|exhelper.print.single.invoice|exhelper.print.single.dosend')) { ?>
