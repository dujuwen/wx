            ...
            <tr>
                ...
                <td style="text-align:left;">
                        ...
                        <?php if(cv('shop.adv.view|shop.adv.edit')) { ?>
                        	<a href="<?php  echo webUrl('shop/adv/edit', array('id' => $row['id']))?>" class="btn btn-default btn-sm" >
                        		<i class='fa fa-edit'></i> <?php if(cv('shop.adv.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>
                        	</a>
                        <?php  } ?>
                        
                        <?php if(cv('shop.adv.delete')) { ?>
                        	<a data-toggle='ajaxRemove' href="<?php  echo webUrl('shop/adv/delete', array('id' => $row['id']))?>"class="btn btn-default btn-sm" data-confirm='确认要删除此幻灯片吗?'><i class="fa fa-trash"></i> 删除</a>
                        <?php  } ?>
