...
<?php  if(is_array($list)) { foreach($list as $key => $value) { ?>
        <tr>
            ...
            <td>
                <a class="btn btn-default btn-sm" title="查看" href="<?php  echo webUrl('exchange/goods/dno',array('id'=>$value['id']));?>"><i class="fa fa-search"></i> 兑换码</a>
                <?php if(cv('exchange.goods.setting')) { ?>
                <a class="btn btn-default btn-sm" href="<?php  echo webUrl('exchange/goods/setting',array('id'=>$value['id']));?>" title="编辑"><i class="fa fa-edit"></i> 编辑</a>
                <?php  } ?>
                <?php if(cv('exchange.goods.delete')) { ?>
                <a class="btn btn-default btn-sm" data-toggle="ajaxRemove" href="<?php  echo webUrl('exchange/goods/delete',array('id'=>$value['id']));?>" data-confirm="确认删除此兑换组？"><i class="fa fa-trash"></i> 删除</a>
                <?php  } ?>
            </td>
        </tr>
<?php  } } ?>
