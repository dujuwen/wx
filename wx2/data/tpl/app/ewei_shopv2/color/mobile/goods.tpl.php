...
<script type='text/html' id='tpl_goods_list'>
	 ...
	 <a <%if g.bargain>0%>href="<?php  echo mobileUrl('bargain/detail')?>&id=<%g.bargain%>"<%else%>href="<?php  echo mobileUrl('goods/detail')?>&id=<%g.id%>"<%/if%>>
	  ...
	  <div class="image"  <%if g.total>0%>data-lazy-background="<%g.thumb%>"<%else%>data-lazy-background="http://m.solomotech.cn/attachment/images/2/2017/05/dHzQBQWdY1Lv1BZZ1w8Q3H8mOZw31L.png"<%/if%> >
