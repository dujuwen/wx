	...
	<div class="order_list clear_in">
		<ul  style="height:80px;">
			...
			<li>
				...
				<i class="icon icon-box" style="font-size:25px;"  ><?php  if($statics['order_1']>0) { ?><span><?php  echo $statics['order_1'];?></span><?php  } ?></i><p class="">待发货</p></a>
			</li>
			<li>
				<a href="<?php  echo mobileUrl('order',array('status'=>2))?>">
				<i class="icon icon-deliver"  style="font-size:25px;" ><?php  if($statics['order_2']>0) { ?><span><?php  echo $statics['order_2'];?></span><?php  } ?></i><p class="">待收货</p></a>
			</li>
			<li>
				<a href="<?php  echo mobileUrl('order',array('status'=>4))?>">
				<i class="icon icon-refund"  style="font-size:25px;"  ><?php  if($statics['order_4']>0) { ?><span><?php  echo $statics['order_4'];?></span><?php  } ?></i><p class="">退款/售后</p></a>
			</li>
		</ul>
	</div>
