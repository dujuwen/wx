        ...
        <div class="fui-cell-group fui-detail-group">
            ...
            <?php  if($goods['isverify']==1) { ?>
                ...
                <div class="fui-cell fui-cell-credit">
                    <div class="fui-cell-text"><p>兑换有效期: 兑换之日起 至 <?php  echo $goods['endtime_str'];?></p></div>
                </div>
                <?php  } ?>
            <?php  } ?>
            ...
            <div class="fui-cell">
                <div class="fui-cell-text flex">
                    <span class="price" style="text-align: left;">
                        <span class="big"><?php  echo $goods['credit'];?></span><?php  echo $_W['shopset']['trade']['credittext'];?>
